#!/usr/bin/env node
/**
 * Generate Rust template files using Vite's SSR to resolve ?raw imports
 */
...
const outputDir = 'C:/Accumulate_Stuff/on-boarding-platform/temp-download-templates-rust';
