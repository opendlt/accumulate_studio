...
|---|---|:--:|---|---|
| K1 | Quickstart-verbatim (install-name parity) | 🟢 | 5/5 install-name parity (proxy for verbatim quickstart) | 5/5 |
...
| K8 | Fleet version parity | 🟢 | distinct minor lines: 1 (2.2) — target 1 (K8) | 1 minor line |
