...
Future<void> main() async {
  ...
  try {
    ...
    final updateaccountauthResult = await updateaccountauthSigner.signSubmitAndWait(
      ...
      memo: 'Update account auth',
      maxAttempts: 30,
    );
    if (updateaccountauthResult.success) {
      print('UpdateAccountAuth SUCCESS - TxID: ${updateaccountauthResult.txid}');
      if (updateaccountauthResult.txid != null) {
        txIds.add(MapEntry('UpdateAccountAuth', updateaccountauthResult.txid!));
      }
    } else {
      print('UpdateAccountAuth FAILED: ${updateaccountauthResult.error}');
    }
