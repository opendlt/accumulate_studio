...
Future<void> main() async {
  ...
  try {
    ...
    // =========================================================
    final createidentityUrl = 'acc://e2e-269173f1.acme';
    ...
    // =========================================================
    final createtokenUrl = 'acc://e2e-269173f1.acme/my-token';
    ...
    final createtokenResult = await createtokenSigner.signSubmitAndWait(
      principal: 'acc://e2e-269173f1.acme',
    ...
    // =========================================================
    final createtokenaccountUrl = 'acc://e2e-269173f1.acme/tokens';
    ...
    final issuetokensResult = await issuetokensSigner.signSubmitAndWait(
      principal: 'acc://e2e-269173f1.acme/my-token',
      body: TxBody.issueTokensSingle(
        toUrl: 'acc://e2e-269173f1.acme/tokens',
        amount: '1000000',
      ),
      memo: 'Issue tokens',
      maxAttempts: 30,
