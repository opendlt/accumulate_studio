...
Future<void> main() async {
  ...
  try {
    ...
    if (transfercreditsResult.success) {
      print('TransferCredits SUCCESS - TxID: ${transfercreditsResult.txid}');
      if (transfercreditsResult.txid != null) {
        txIds.add(MapEntry('TransferCredits', transfercreditsResult.txid!));
      }
    } else {
      print('TransferCredits FAILED: ${transfercreditsResult.error}');
    }
