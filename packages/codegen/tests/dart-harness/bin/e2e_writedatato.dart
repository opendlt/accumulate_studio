...
Future<void> main() async {
  ...
  try {
    ...
    if (writedatatoResult.success) {
      print('WriteDataTo SUCCESS - TxID: ${writedatatoResult.txid}');
      if (writedatatoResult.txid != null) {
        txIds.add(MapEntry('WriteDataTo', writedatatoResult.txid!));
      }
    } else {
      print('WriteDataTo FAILED: ${writedatatoResult.error}');
    }
