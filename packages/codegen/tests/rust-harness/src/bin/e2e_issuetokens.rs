...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // =========================================================
    let createidentity_url = "acc://e2e-4dd54c48.acme".to_string();
    ...
    // =========================================================
    let createtoken_url = "acc://e2e-4dd54c48.acme/my-token".to_string();
    ...
    // =========================================================
    let createtokenaccount_url = "acc://e2e-4dd54c48.acme/tokens".to_string();
    ...
    let issuetokens_result = issuetokens_signer.sign_submit_and_wait(
        "acc://e2e-4dd54c48.acme/my-token",
        &TxBody::issue_tokens_single("acc://e2e-4dd54c48.acme/tokens", "1000000"),
        Some("Issue tokens"),
        30,
    ).await;
