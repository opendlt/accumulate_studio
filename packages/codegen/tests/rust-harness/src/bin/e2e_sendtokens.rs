...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // =========================================================
    let mut sendtokens_signer = SmartSigner::new(&client, generatekeys_signer.clone(), &generatekeys_lid);
    let sendtokens_result = sendtokens_signer.sign_submit_and_wait(
        "acc://e2e-0c089c3b.acme/tokens",
        &TxBody::send_tokens_single("acc://e2e-0c089c3b.acme/tokens", "100"),
        Some("Send tokens"),
        30,
    ).await;
