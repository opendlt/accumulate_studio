...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // =========================================================
    let createidentity_url = "acc://e2e-f1e72463.acme".to_string();
    ...
    // =========================================================
    let mut createkeypage_signer = SmartSigner::new(&client, generatekeys_signer.clone(), &format!("{}/book/1", createidentity_url));
    ...
    // =========================================================
    let mut transfercredits_signer = SmartSigner::new(&client, generatekeys_signer.clone(), &format!("{}/book/1", createidentity_url));
    let transfercredits_result = transfercredits_signer.sign_submit_and_wait(
        "acc://e2e-f1e72463.acme/book/1",
        &TxBody::transfer_credits("acc://e2e-f1e72463.acme/book/1", 100),
