...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let createidentity_result = createidentity_signer.sign_submit_and_wait(
        &generatekeys_lta,
        &TxBody::create_identity("acc://e2e-51580b7e.acme", "acc://e2e-51580b7e.acme/book", &generatekeys_pub_hash),
        Some("Create ADI"),
        30,
    ).await;
    ...
    let createdataaccount_result = createdataaccount_signer.sign_submit_and_wait(
        "acc://e2e-51580b7e.acme",
        &TxBody::create_data_account("acc://e2e-51580b7e.acme/data"),
