...
async function main() {
    ...
    try {
        ...
        // =========================================================
        const createidentityUrl = "acc://e2e-d546e690.acme";
        ...
        // =========================================================
        console.log("Waiting for credits >= 100...");
        await pollForCredits(client, `${createidentityUrl}/book/1`, 100);
        console.log("Credits reached");
        ...
        // =========================================================
        const createtokenUrl = "acc://e2e-d546e690.acme/my-token";
        const createtokenSigner = new SmartSigner(client, generatekeysKp.toKey(), `${createidentityUrl}/book/1`);
        const createtokenResult = await createtokenSigner.signSubmitAndWait(
            "acc://e2e-d546e690.acme",
            TxBody.createToken(
                "acc://e2e-d546e690.acme/my-token",
                "TKN",
                8,
            ),
        );
        ...
        // =========================================================
        const createtokenaccountUrl = "acc://e2e-d546e690.acme/tokens";
        ...
        // =========================================================
        const issuetokensSigner = new SmartSigner(client, generatekeysKp.toKey(), `${createidentityUrl}/book/1`);
        ...
        // =========================================================
        const burntokensSigner = new SmartSigner(client, generatekeysKp.toKey(), `${createidentityUrl}/book/1`);
        const burntokensResult = await burntokensSigner.signSubmitAndWait(
            "acc://e2e-d546e690.acme/tokens",
            TxBody.burnTokens("500"),
        );
        if (burntokensResult.success) {
            console.log(`BurnTokens SUCCESS - TxID: ${burntokensResult.txid}`);
            if (burntokensResult.txid) txIds.push(["BurnTokens", burntokensResult.txid]);
        } else {
            console.log(`BurnTokens FAILED: ${burntokensResult.error}`);
        }
