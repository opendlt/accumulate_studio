    ...
    try {
        ...
        const createidentityResult = await createidentitySigner.signSubmitAndWait(
            ...
            TxBody.createIdentity(
                "acc://e2e-66cb2241.acme",
                "acc://e2e-66cb2241.acme/book",
                generatekeysPubHash,
            ),
        );
        ...
        // =========================================================
        const createtokenSigner = new SmartSigner(client, generatekeysKp.toKey(), generatekeysLid);
        const createtokenResult = await createtokenSigner.signSubmitAndWait(
            "acc://e2e-66cb2241.acme",
            TxBody.createToken(
                "acc://e2e-66cb2241.acme/my-token",
                "TKN",
                8,
            ),
        );
        ...
        // =========================================================
        const issuetokensSigner = new SmartSigner(client, generatekeysKp.toKey(), generatekeysLid);
        ...
        // =========================================================
        const burntokensSigner = new SmartSigner(client, generatekeysKp.toKey(), generatekeysLid);
