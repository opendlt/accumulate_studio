    ...
    try {
        ...
        const createidentityResult = await createidentitySigner.signSubmitAndWait(
            ...
            TxBody.createIdentity(
                "acc://e2e-de4a554c.acme",
                "acc://e2e-de4a554c.acme/book",
                generatekeysPubHash,
            ),
        );
        ...
        // =========================================================
        const transfercreditsSigner = new SmartSigner(client, generatekeysKp.toKey(), generatekeysLid);
        const transfercreditsResult = await transfercreditsSigner.signSubmitAndWait(
            "acc://e2e-de4a554c.acme/book/1",
