...
async function main() {
    ...
    try {
        ...
        // =========================================================
        const createidentityUrl = "acc://e2e-7bfe6f72.acme";
        ...
        // =========================================================
        const updatekeySigner = new SmartSigner(client, generatekeysKp.toKey(), `${createidentityUrl}/book/1`);
        const updatekeyResult = await updatekeySigner.signSubmitAndWait(
            "acc://e2e-7bfe6f72.acme/book/1",
