...
async function main() {
    ...
    try {
        ...
        // =========================================================
        const createidentityUrl = "acc://e2e-59e93003.acme";
        ...
        // =========================================================
        const createtokenaccountUrl = "acc://e2e-59e93003.acme/tokens";
        ...
        const createtokenaccountResult = await createtokenaccountSigner.signSubmitAndWait(
            "acc://e2e-59e93003.acme",
            TxBody.createTokenAccount(
                "acc://e2e-59e93003.acme/tokens",
                "acc://ACME",
            ),
        );
        ...
        // =========================================================
        const updateaccountauthSigner = new SmartSigner(client, generatekeysKp.toKey(), `${createidentityUrl}/book/1`);
        const updateaccountauthResult = await updateaccountauthSigner.signSubmitAndWait(
            "acc://e2e-59e93003.acme",
            TxBody.updateAccountAuth([{"type":"enable","authority":"acc://e2e-59e93003.acme/book"}]),
        );
        if (updateaccountauthResult.success) {
            console.log(`UpdateAccountAuth SUCCESS - TxID: ${updateaccountauthResult.txid}`);
            if (updateaccountauthResult.txid) txIds.push(["UpdateAccountAuth", updateaccountauthResult.txid]);
        } else {
            console.log(`UpdateAccountAuth FAILED: ${updateaccountauthResult.error}`);
        }
