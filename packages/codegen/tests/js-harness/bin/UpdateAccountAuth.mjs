    ...
    try {
        ...
        const createidentityResult = await createidentitySigner.signSubmitAndWait(
            ...
            TxBody.createIdentity(
                "acc://e2e-a70af80d.acme",
                "acc://e2e-a70af80d.acme/book",
                generatekeysPubHash,
            ),
        );
        ...
        // =========================================================
        const updateaccountauthSigner = new SmartSigner(client, generatekeysKp.toKey(), generatekeysLid);
        const updateaccountauthResult = await updateaccountauthSigner.signSubmitAndWait(
            "acc://e2e-a70af80d.acme",
            TxBody.updateAccountAuth([{"type":"enable","authority":"acc://e2e-a70af80d.acme/book"}]),
        );
