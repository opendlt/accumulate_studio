...
async function main() {
    ...
    try {
        ...
        // =========================================================
        const createidentityUrl = "acc://e2e-b6fec66f.acme";
        ...
        // =========================================================
        const createdataaccountUrl = "acc://e2e-b6fec66f.acme/data";
        const createdataaccountSigner = new SmartSigner(client, generatekeysKp.toKey(), `${createidentityUrl}/book/1`);
        const createdataaccountResult = await createdataaccountSigner.signSubmitAndWait(
            "acc://e2e-b6fec66f.acme",
            TxBody.createDataAccount("acc://e2e-b6fec66f.acme/data"),
        );
        ...
        // =========================================================
        const writedataSigner = new SmartSigner(client, generatekeysKp.toKey(), `${createidentityUrl}/book/1`);
        const writedataResult = await writedataSigner.signSubmitAndWait(
            "acc://e2e-b6fec66f.acme/data",
            TxBody.writeData(["Hello World"]),
        );
