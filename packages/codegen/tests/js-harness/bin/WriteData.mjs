    ...
    try {
        ...
        const createidentityResult = await createidentitySigner.signSubmitAndWait(
            ...
            TxBody.createIdentity(
                "acc://e2e-28647133.acme",
                "acc://e2e-28647133.acme/book",
                generatekeysPubHash,
            ),
        );
        ...
        // =========================================================
        const createdataaccountSigner = new SmartSigner(client, generatekeysKp.toKey(), generatekeysLid);
        const createdataaccountResult = await createdataaccountSigner.signSubmitAndWait(
            "acc://e2e-28647133.acme",
            TxBody.createDataAccount("acc://e2e-28647133.acme/data"),
        );
        ...
        // =========================================================
        const writedataSigner = new SmartSigner(client, generatekeysKp.toKey(), generatekeysLid);
        const writedataResult = await writedataSigner.signSubmitAndWait(
            "acc://e2e-28647133.acme/data",
            TxBody.writeData([
                "Hello World",
            ]),
        );
