...
async function main() {
    ...
    try {
        ...
        // =========================================================
        const createidentityUrl = "acc://e2e-a8df0292.acme";
        ...
        // =========================================================
        const createtokenUrl = "acc://e2e-a8df0292.acme/my-token";
        ...
        const createtokenResult = await createtokenSigner.signSubmitAndWait(
            "acc://e2e-a8df0292.acme",
            TxBody.createToken(
                "acc://e2e-a8df0292.acme/my-token",
                "TKN",
                8,
            ),
        );
        ...
        // =========================================================
        const createtokenaccountUrl = "acc://e2e-a8df0292.acme/tokens";
