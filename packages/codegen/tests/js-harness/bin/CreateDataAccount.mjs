...
async function main() {
    ...
    try {
        ...
        // =========================================================
        const createidentityUrl = "acc://e2e-a0a59592.acme";
        ...
        // =========================================================
        const createdataaccountUrl = "acc://e2e-a0a59592.acme/data";
        ...
        const createdataaccountResult = await createdataaccountSigner.signSubmitAndWait(
            "acc://e2e-a0a59592.acme",
            TxBody.createDataAccount("acc://e2e-a0a59592.acme/data"),
        );
