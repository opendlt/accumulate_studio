...
async function main() {
    ...
    try {
        ...
        // =========================================================
        const createidentityUrl = "acc://e2e-c65ca669.acme";
        ...
        // =========================================================
        const createtokenaccountUrl = "acc://e2e-c65ca669.acme/tokens";
        ...
        const createtokenaccountResult = await createtokenaccountSigner.signSubmitAndWait(
            "acc://e2e-c65ca669.acme",
            TxBody.createTokenAccount(
                "acc://e2e-c65ca669.acme/tokens",
                "acc://ACME",
            ),
        );
